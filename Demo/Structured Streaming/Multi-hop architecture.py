...
##schema inference by giving the schema location
(spark.readStream
    .format("cloudFiles")
...
##append the data from orders_temp to orders_bronze
...
##static table creation using pyspark
(spark.read
      .format("json")
...
##created a streaming orders_bronze temp view
(spark.readStream
  .table("orders_bronze")
...
#joined together static and streaming data and created new temp view in above statement
#creates orders_silver table in incremental mode from orders_enriched_temp view
